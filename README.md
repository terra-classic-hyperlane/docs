...
- **Relayer setup:** [validator/relayer VPS guide](https://github.com/terra-classic-hyperlane/hyperlane-validator/blob/main/hyperlane-validator-relayer-vps-english.md) · [Docker guide](https://github.com/terra-classic-hyperlane/hyperlane-validator/blob/main/DOCKER-INSTALLATION-GUIDE.md) · [relayer on the production VPS](https://github.com/terra-classic-hyperlane/proof-of-delivery/blob/main/docs/RELAYER-VPS.md) · [relayer API guide](https://github.com/terra-classic-hyperlane/hyperlane-validator/blob/main/hyperlane-relayer-api-guide.md)
